...
public class AppData {
    ...
    private static final String WATCHLIST_ROOT = "watchlists";
    ...
    protected static DatabaseReference watchlistRootReference = firebaseDatabase.getReference().child(WATCHLIST_ROOT);
